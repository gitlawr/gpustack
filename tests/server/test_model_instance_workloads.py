...
def test_the_fold_agrees_with_what_the_worker_decides_today(states):
    ...
    reference = ServeManager._get_main_worker_distributed_state(
        mi, subordinate_placements(mi)
    )
...
def test_the_fold_words_a_follower_failure_the_way_the_worker_does(
    ...
    from_worker = ServeManager._get_main_worker_distributed_state(
        instance, subordinate_placements(instance)
    )
